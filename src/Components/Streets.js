...
{countse.map((index,key) => (
  <div className="col-lg-4 col-md-6 portfolio-item ">
    <div className="portfolio-img">
        <a key={key} href={'portfolio/Street/'+index+'.jpg'} data-gallery="portfolioGallery" className="portfolio-lightbox preview-link" title="">
        <img key={key} src={'thumbnail/Street/'+index+'.jpg'} className="img-fluid" alt=""/>      
        </a>
    </div>
  </div>
  )
